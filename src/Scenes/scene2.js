    ...
    function fomartFunc() {
        ...
        if (completedCount == 0) {
            if (isOneStepFinished) {
                audioList.bodyAudio.src = "./sounds/EP_52_Audio_01.mp3"
                ...
                audioList.bodyAudio.src = "./sounds/EP_52_Audio_03.mp3"
                timerList[0] = setTimeout(() => {
                    audioList.bodyAudio.play()
                }, 2000);
            ...
            if (isOneStepFinished) {
                audioList.bodyAudio.src = "./sounds/EP_52_Audio_14_A.mp3"
                audioList.subBodyAudio.src = "./sounds/EP_52_Audio_14_B.mp3"
        ...
        >
            <div
                ...
                <img draggable={false} width={"100%"}
                    src={"./images/SB_52_BG/SB_52_Transition_BG_1/SB_52_Transition_BG_1_Board.svg"}
                />
            </div>
            ...
            <div
                ...
                <img draggable={false} width={"100%"}
                    src={"./images/SB_52_BG/SB_52_Transition_BG_1/SB_52_Transition_BG_1_Drawings-on-Board.svg"}
                />
            </div>

            <div
                style={{
                    position: "fixed", width: _baseGeo.width * 0.33 + "px"
                    , left: _baseGeo.left + _baseGeo.width * 0.33 + "px",
                    bottom: 0.4 * _baseGeo.height + "px",
                }}>
                <img draggable={false} width={"100%"}
                    src={"./images/SB_52_BG/SB_52_Transition_BG_1/SB_52_Transition_BG_1_Text.svg"}
                />
            </div>
            ...
            <div
                ...
                <img draggable={false} width={"100%"}
                    src={"./images/SB_52_BG/SB_52_Transition_BG_1/SB_52_Transition_BG_1_Books-Pencils.svg"}
                />
            </div>
            ...
            <div
                ...
                <img draggable={false} width={"100%"}
                    src={"./images/SB_52_BG/SB_52_Transition_BG_1/SB_52_Transition_BG_1_Bag-Globe.svg"}
                />
            </div>
            ...
            <div
                ...
                onClick={() => {
                    setTimeout(() => {
                        nextFunc(); audioList.clickAudio.play().catch(error => { })
                    }, 200);
                }}
                style={{
