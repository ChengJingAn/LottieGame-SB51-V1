...
const FullScreenBtn = React.forwardRef((prop, ref) => {
    ...
    return (
        <div
            ...
            <img draggable={false} 
                width={"100%"}
                src={"./images/Buttons/" + (!isFullScreen ? "fullscreen-svgrepo-com" : "exit-full-screen-svgrepo-com") + ".svg"}
            />
        </div>
    )
});
    ...
    return (
        <div
            ...
            <img draggable={false}
                ...
                width={"100%"}
                src={"./images/Buttons/" + (_isBackSoundPlaying ? "Audio_unmute" : "Audio_mute") + ".svg"}
            />
        </div>
    )
});
